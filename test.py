...
IN3_motor4 = 15  # GPIO15 -> Pin 10 on Jetson (Check if this is correct; sometimes GPIO15 is not exposed)
IN4_motor4 = 14  # GPIO14 -> Pin 8 on Jetson (Check if this is correct)
